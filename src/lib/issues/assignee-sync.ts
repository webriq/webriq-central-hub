...
// Task 351 — issues went multi-assignee (`issues.assignees uuid[]`, migration 132) but the
...
export type IssueAssigneeSyncColumns = {
  assignees: string[];
...
export async function buildIssueAssigneeSync(
  supabase: SupabaseClient<Database>,
  assignees: unknown,
): Promise<IssueAssigneeSyncColumns> {
