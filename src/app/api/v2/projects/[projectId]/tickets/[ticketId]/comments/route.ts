...
// (project_id lookup first, matching .../tickets/[ticketId]/attachments/route.ts's own pattern,
// since tickets don't have a bare /api/v2/tickets/[ticketId]/comments mount). `issue_comments`
...
// with no Hub account).
// Task 257, Requirement E — `source_meta.attachments` (zoho-import/ticket-comments/route.ts) is
...
// GET /api/v2/projects/[projectId]/tickets/[ticketId]/comments — chronological list, author-resolved
...
// POST /api/v2/projects/[projectId]/tickets/[ticketId]/comments — create a comment as the current
// user. Not gated by getTicketEditPermission — any staff role with page access may comment
...
export async function POST(
  ...
  if (error) {
    console.error("[api/v2/projects/[id]/tickets/[id]/comments] insert failed:", error.message);
