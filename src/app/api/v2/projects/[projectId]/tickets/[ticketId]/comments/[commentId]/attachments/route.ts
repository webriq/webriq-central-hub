...
// 049 — no change needed there, task/ticket comments share the same table) and the same private
...
export async function POST(
  ...
  if (uploadError) {
    console.error("[api/v2/projects/[id]/tickets/[id]/comments/[id]/attachments] upload failed:", uploadError.message);
  ...
  if (error) {
    console.error("[api/v2/projects/[id]/tickets/[id]/comments/[id]/attachments] insert failed:", error.message);
