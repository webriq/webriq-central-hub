...
// Images pasted/dropped into an ticket comment body's rich-text editor (task 236) — mirrors
...
export async function POST(
  ...
  const storagePath = `${ticket.id}/${timestamp}_${safeFilename}`;
  ...
  if (uploadError) {
    console.error("[api/v2/projects/[id]/tickets/[id]/comments/description-images] upload failed:", uploadError.message);
