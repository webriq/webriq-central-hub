...
export async function POST(
  ...
  try {
    ...
    const {
      ...
      fields, file_path, file_name, file_size, file_mime_type, phase_number, project_id, folder_id,
    } = body as {
    ...
    // Task 350 — the storage path is server-generated by the upload/upload-sign route; never
    // register a path outside this customer's own tree (the client now sees the path explicitly).
