...
import { FilterMultiSelect } from "@/app/(hub)/projects/_v2-listing/_filter-multi-select";
import { SortSelect } from "@/app/(hub)/projects/_v2-listing/_sort-select";
    ...
    <div>
      <div className="sticky top-0 z-20 bg-[#F4F6FB]">
        <div className="max-w-350 mx-auto px-8 pt-6 pb-4">
          <Link href={V2_ROUTES.PROJECTS_V2} className="inline-flex items-center gap-1.5 text-[12px] font-medium text-[#5F6A88] hover:text-[#0B1533] transition-colors mb-2">
