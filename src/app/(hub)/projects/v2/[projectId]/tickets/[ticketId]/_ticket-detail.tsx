...
export default function TicketDetailClient({
  ...
  const goToTickets = useCallback(() => {
    if (project.project_id) router.push(`/projects/v2/${project.project_id}/tickets`);
  ...
  function saveAssignees(nextIds: string[]) {
    ...
    // synced scalar `assignee_id`/`assignee_name` columns from this array for the Zoho export
    // and any legacy display path.
