...
export function WorkspaceHeader({
  ...
  // Points at this project's Timeline page under the unified `/projects/v2` detail tree —
  // same destination the old "Back to {project name}" button used, per user feedback replacing
  // the 3-level breadcrumb with a single back-link. Task 276 (Phase 3) — was
  // `${V2_ROUTES.PORTFOLIO_TRACKER}/${projectRouteId}`. Task 277 — `/timeline`, not the bare
  // project URL: Overview is now a "coming soon" placeholder, the swimlane moved to Timeline.
  const portfolioTrackerHref = projectRouteId ? `/projects/v2/${projectRouteId}/timeline` : "/projects/v2";
