...
// Task 311 — Notes tab (`_shared/_notes-tab.tsx`) wired up here as a real V2 subroute, mirroring
// the Files tab's own page (`(tabs)/files/page.tsx`). `ProjectDetail`'s PRIMARY_TABS entry id is
// "notes", matching this folder name for the tab-strip's `router.push` navigation.
