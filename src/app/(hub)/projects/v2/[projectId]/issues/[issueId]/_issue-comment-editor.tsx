...
// Rich-text comment composer for Issue Detail (task 236) — copy-adapted from
...
// parent-driven `key` remount (see IssueComments).
export function IssueCommentEditor({
  ...
  async function uploadAndInsertImage(file: File) {
    ...
    fd.append("file", file);
    const res = await fetch(`/api/v2/projects/${projectId}/issues/${issueId}/comments/description-images`, {
      method: "POST",
      body: fd,
    });
    setUploading(false);
