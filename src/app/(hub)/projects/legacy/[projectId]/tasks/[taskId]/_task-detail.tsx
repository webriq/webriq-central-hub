...
export default function TaskDetailClient({
  ...
  async function handleDelete() {
    ...
    if (project.project_id) router.push(`/projects/legacy/${project.project_id}/tasks`);
  }
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      <div className="px-8 pt-6 pb-5 bg-white border-b border-[#E2E7F2] shrink-0">
        <button
          onClick={() => project.project_id && router.push(`/projects/legacy/${project.project_id}/tasks`)}
