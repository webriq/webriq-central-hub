    ...
    <div className="relative h-full">
      {editable ? (
        <div
          ...
          onClick={() => router.push(`${V2_ROUTES.PROJECTS_V2}/${item.project_id ?? item.id}/timeline`)}
          onKeyDown={(e) => {
            if (e.key === "Enter") router.push(`${V2_ROUTES.PROJECTS_V2}/${item.project_id ?? item.id}/timeline`);
          }}
