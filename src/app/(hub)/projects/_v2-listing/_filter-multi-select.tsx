...
// Checkbox-group dropdown, ported from /projects' _projects-index.tsx (task 224). "All" is
...
// Tracker + its Status Report sub-page) — this does not cross into /projects, which keeps
