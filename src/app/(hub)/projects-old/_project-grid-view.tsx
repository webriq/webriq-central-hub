...
function ProjectGridCard({
  ...
  return (
    <div className="group relative h-full">
      <Link
        href={p.project_id ? `${V2_ROUTES.PROJECTS_OLD}/${p.project_id}` : V2_ROUTES.PROJECTS_OLD}
        ...
        <div className="mt-auto pt-3 border-t border-[#EDF0F7] flex items-center justify-between gap-2">
          ...
          <div className="pointer-events-auto flex items-center gap-3 shrink-0">
            <ProgressStat
              ...
              total={p.task_total}
              href={p.project_id ? `${V2_ROUTES.PROJECTS_OLD}/${p.project_id}/tasks` : undefined}
            ...
            <ProgressStat
              ...
              total={p.issue_total}
              href={p.project_id ? `${V2_ROUTES.PROJECTS_OLD}/${p.project_id}/issues` : undefined}
