...
export default function MilestoneDetailClient({
  ...
  const goToMilestones = useCallback(() => {
    if (project.project_id) router.push(`/projects-old/${project.project_id}/milestones`);
                ...
                <div className="flex flex-col gap-1">
                  {linkedTasks.map((t) => {
                    ...
                    return (
                      <button
                        key={t.id}
                        onClick={() => project.project_id && router.push(`/projects-old/${project.project_id}/tasks/${t.display_id}`)}
