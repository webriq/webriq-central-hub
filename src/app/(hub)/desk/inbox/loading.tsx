...
function RowSkeleton() {
  return (
    <div className="grid grid-cols-[1fr_170px_150px_150px_130px] items-center gap-3 px-5 py-3 border-b border-[#EDF0F7] last:border-0">
...
export default function DeskInboxLoading() {
  return (
    <div>
      {/* Header */}
      ...
      <div className="max-w-[1400px] mx-auto px-8 py-5">
        <div className="rounded-[14px] border border-[#E2E7F2] bg-white overflow-hidden">
          <div className="grid grid-cols-[1fr_170px_150px_150px_130px] gap-3 px-5 py-2.5 border-b border-[#EDF0F7] bg-[#FAFBFE]">
            <Bone className="h-3 w-14" />
