...
import { postLoginGate } from "@/app/(auth)/actions";
    ...
    <AuthSplitShell title="Welcome back" subtitle="Sign in to your account to continue.">
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <PasswordInput
          ...
          headerAction={
            <Link href="/auth/forgot-password" className="text-sm font-semibold text-auth-blue-700 hover:text-auth-blue transition-colors">
              Forgot password?
            </Link>
          }
        />
