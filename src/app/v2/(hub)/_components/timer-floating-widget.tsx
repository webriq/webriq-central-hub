...
import { Timer, Utensils, Coffee, Clock, X, Play, Pause, Square } from "lucide-react";
...
const BREAK_META: Record<BreakType, { icon: LucideIcon; label: string; tooltip: string }> = {
  meal: { icon: Utensils, label: "60 mins", tooltip: "Meal Break for 60 mins" },
  coffee: { icon: Coffee, label: "15 mins", tooltip: "Coffee Break for 15 mins" },
  few_minutes: { icon: Clock, label: "Few Minutes Break", tooltip: "Few Minutes Break for 5 mins" },
};
                    ...
                    <Tooltip key={type}>
                      <TooltipTrigger render={
                        <button
                          ...
                          className="flex flex-col items-center gap-1 px-1.5 py-2 rounded-[10px] border border-[#E2E7F2] bg-white hover:border-[#A8C6F5] hover:bg-[#F0F7FF] transition-colors cursor-pointer"
                        >
